...
const DraLuanaCastro: React.FC<DraLuanaCastroProps> = () => {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('dra_luana_sessions');
    if (saved) {
                ...
                <div className="flex gap-4 bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 animate-pulse">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-slate-400 font-medium uppercase tracking-widest animate-pulse">Analisando CLT e Jurisprudência...</span>
                    </div>
                    <div className="space-y-2">
